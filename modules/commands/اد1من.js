...
module.exports.languages = {
    ...
    "en": {
        "listAdmin": '[آدمين] قائمة المشرفين: \n\n%1',
        "notHavePermssion": '[المشرف] أنت ليس لديك الإذن لإستخدام أمر "%1"',
        "addedNewAdmin": '[المشرف] تمت إضافة %1 كمشرف :\n\n%2',
        "removedAdmin": '[المشرف] تمت إزالت %1 كمشرف:\n\n%2'
    }
}
...
module.exports.run = async function ({ api, event, args, Users, permssion, getText }) {
    ...
    switch (args[0]) {
        ...
        case "all":
        case "-a": {
            const listAdmin = ADMINBOT || config.ADMINBOT || [100076269693499];
            var msg = [];
